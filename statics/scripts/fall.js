...
class Fall {
    constructor(container, items, density, speed) {
        this._fallEleList = [];
    ...
    generateFallElement(count, isInit) {
...
class FallElement {
    constructor(container, item, speed, isInit) {
        this.item = item;
        this.speed = speed;
        this.container = container;
    ...
    _getStyle() {
        return `
            ...
            top: 0;
            left: 0;
            transition: transform ${1000 * this.speed + 1000}ms linear;
